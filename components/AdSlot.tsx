...
type GeneralSize = [number, number] | 'fluid';

type AdSlotProps = {
  id: string
  label?: string
  /** Aceita ambos para compat (fix do build): */
  size?: string
  sizes?: string
  className?: string
  variant?: 'leaderboard' | 'skyscraper' | 'native-card'
  /** opcional: tamanhos GPT sem depender do namespace googletag */
  gptSizes?: GeneralSize[]
}
